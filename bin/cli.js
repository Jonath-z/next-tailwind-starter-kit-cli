...
const checkoutCommand = `git clone https://github.com/Jonath-z/next-tailwind-starter-kit.git ${
  repoName || "."
}`;

// checkout and install dependencies command
const installCommand = repoName
  ? `cd ${repoName} && npm install`
  : "npm install";

// cloning startert kit message
console.log(
  `cloning the starter kit with name ${repoName || "of the current directory"}`
);
...
console.log(
  `install dependencies for ${
    repoName || "the project in the current directory"
  }`
);
